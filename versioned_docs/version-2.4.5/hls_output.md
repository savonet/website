---
title: "HLS Output"
description: "Starting with liquidsoap 1.4.0, it is possible to send your streams as HLS output. Since version 2.4.3, fragemented MP4 fMP4 is also fully supported…"
sidebar_label: "HLS output"
---
...
```liquidsoap title="output.file.hls.liq"
...
## Keyframes and segment length {#keyframes-and-segment-length}
...
```liquidsoap title="hls-metadata.liq"
s = mksafe(playlist("playlist"))
