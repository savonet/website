...
```liquidsoap title="raw-string.liq"
...
```liquidsoap title="raw-string-delimited.liq"
...
#### Time predicates {#time-predicates}
...
#### Anonymous function with no arguments {#anonymous-function-with-no-arguments}
...
### Advanced argument syntax {#advanced-argument-syntax}
...
```liquidsoap title="labeled_arguments.liq"
...
## Records and modules {#records-and-modules}
...
### Values with fields {#values-with-fields}
...
### Record and module patterns {#record-and-module-patterns}
...
### Cache and memory usage {#cache-and-memory-usage}
