---
title: "Liquidsoap scripting language reference"
description: "The Source / ... categories contain all functions that return sources. The Input functions are those which build elementary sources (playing files,…"
---
...
<ApiIndex src="/doc-2.4.5/reference-deprecated-index.json" />
