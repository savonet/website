---
title: "Uncategorized"
description: "Deprecated: use decoder.metadata.add."
---
### `add_metadata_resolver` {#add_metadata_resolver}
...
### `add_playlist_parser` {#add_playlist_parser}
...
### `get_process_lines` {#get_process_lines}
...
### `output.preferred` {#output.preferred}
...
### `playlist.reloadable` {#playlist.reloadable}
...
### `request.create.raw` {#request.create.raw}
...
### `request.dynamic.list` {#request.dynamic.list}
...
### `source.last_metadata` {#source.last_metadata}
...
### `source.on_frame` {#source.on_frame}
...
### `source.on_offset` {#source.on_offset}
...
### `string.utf8.escape` {#string.utf8.escape}
...
### `video.rectangle` {#video.rectangle}
...
### `video.transparent` {#video.transparent}
