---
title: "RadioPi"
description: "RadioPi is the web radio of the ECP (Ecole Centrale de Paris). RadioPi runs many channels. There are topical channels (Reggae, Hip-Hop, Jazz, ...). On…"
---
...
def channel_radiopilote(~skip=true, name) =
  ...
  s.on_metadata(synchronous=false, lastfm)
