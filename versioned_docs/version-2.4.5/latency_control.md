---
title: "Understanding Latency in Liquidsoap"
description: "To generate a media stream, Liquidsoap runs a media streaming loop. This loop creates small chunks of audio or video data (e.g. 0.04 seconds long) and…"
sidebar_label: "Latency control"
---
...
#### 1. `self-sync` sources (external time control) {#self-sync-sources-external-time-control}
...
#### 2. CPU-Controlled Latency (internal time control) {#cpu-controlled-latency-internal-time-control}
