...
description: "If you want to have a constant average volume on any audio stream, you can use the normalize operator. However, this operator cannot guess the volume…"
sidebar_label: "Loudness normalization"
---
...
### Computing or retrieving loudness correction information {#computing-or-retrieving-loudness-correction-information}
...
#### Using metadata resolvers {#using-metadata-resolvers}
...
#### Using protocol resolvers {#using-protocol-resolvers}
...
### Applying loudness correction {#applying-loudness-correction}
...
```liquidsoap title="loudness-correction.liq"
