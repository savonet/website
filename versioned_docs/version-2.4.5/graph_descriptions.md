---
title: "Visualizing clocks and sources"
description: "As Liquidsoap scripts grow more complex — multiple clocks, many sources, transitions, time-dependent behaviors — it can become difficult to reason…"
sidebar_label: "Understand your script"
---
...
## Using the telnet interface {#using-the-telnet-interface}
...
## Using the scripting API {#using-the-scripting-api}
