...
## Enable/disable ICY metadata updates {#enabledisable-icy-metadata-updates}
...
## Update metadata manually {#update-metadata-manually}
...
```liquidsoap title="icy-update.liq"
def icy_update(v) =
 # Parse the argument
