---
title: "Source / Output"
description: "Output an MPEG-DASH playlist."
---
...
```
(?id : string?, ?fallible : bool, ?codec : string, ?bitrate : int,
 ?start : bool, ?playlist : string, directory : string,
 source(audio=pcm(stereo))) -> unit
```
