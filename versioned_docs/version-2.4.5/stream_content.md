...
description: "In liquidsoap, a stream may contain any number of audio, video and event MIDI channels (though this has not been tested in a while!). As part of the…"
---
...
## Checking stream contents {#checking-stream-contents}
...
## Guessing stream contents {#guessing-stream-contents}
