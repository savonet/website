...
description: "The %ffmpeg encoder supports all options for ffmpeg's muxers and encoders, including private options. Options are passed as key/value pairs, with…"
---
