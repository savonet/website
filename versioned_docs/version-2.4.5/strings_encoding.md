...
description: "Liquidsoap operates internally using the UTF-8 string encoding. Most strings inside the application are converted to UTF-8 whenever possible.…"
---
...
detection is set via [settings.charset.encodings](./settings.md#list-of-encodings-to-try-for-automatic-encoding-detection.)
