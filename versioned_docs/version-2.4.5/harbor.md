---
title: "Harbor input"
description: "Liquidsoap is also able to receive a source using icecast or shoutcast source protocol with the input.harbor operator. Using this operator, the running…"
---
...
```liquidsoap title="harbor-usage.liq"
