...
#### Associative lists as objects {#associative-lists-as-objects}
...
## Exporting JSON values {#exporting-json-values}

Exporting JSON values can be done using the `json.stringify` function:

```liquidsoap title="json-stringify.liq"
...
## Generic JSON objects {#generic-json-objects}
