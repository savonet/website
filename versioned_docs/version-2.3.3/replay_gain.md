---
title: "Normalization and ReplayGain"
description: "If you want to have a constant average volume on an audio stream, you can use the normalize operator. However, this operator cannot guess the volume of…"
sidebar_label: "Normalization and replay gain"
---
...
### Computing or retrieving replay gain information {#computing-or-retrieving-replay-gain-information}
...
#### Using the replay gain metadata resolver {#using-the-replay-gain-metadata-resolver}
...
#### Using the `replaygain:` protocol {#using-the-replaygain-protocol}
...
### Applying replay gain information {#applying-replay-gain-information}
...
```liquidsoap title="replaygain-metadata.liq"
enable_replaygain_metadata()
...
```liquidsoap title="replaygain-playlist.liq"
enable_replaygain_metadata()
