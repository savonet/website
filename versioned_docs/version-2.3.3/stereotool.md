...
description: "Starting with version 2.2.0, liquidsoap supports the shared library distributed by Thimeo Audio Technology using the stereotool operator (and…"
sidebar_label: "Stereotool"
---
