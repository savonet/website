---
title: "Multitrack support"
description: "Starting with version 2.2.0, liquidsoap now supports track operations, making it possible to manipulate data at the track level, including demuxing,…"
...
## Multitrack sources {#multitrack-sources}
...
```liquidsoap title="multitrack.liq"
s = single("/path/to/movie.mkv")
...
```liquidsoap title="multitrack2.liq"
s = single("/path/to/movie.mkv")
...
```liquidsoap title="multitrack3.liq"
...
## Tracks demuxing and muxing {#tracks-demuxing-and-muxing}
...
```liquidsoap title="multitrack-add-video-track.liq"
...
```liquidsoap title="multitrack-add-video-track2.liq"
# A playlist of audio files
s = playlist("a_playlist")
...
### Add a default video track {#add-a-default-video-track}

You can also check if a source has a certain track and do something accordingly:

```liquidsoap title="multitrack-default-video-track.liq"
s = playlist("a_playlist")
...
### Merge all tracks {#merge-all-tracks}
