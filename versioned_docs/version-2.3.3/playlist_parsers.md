---
title: "Playlist parsers"
description: "Liquidsoap supports various playlists formats. Those formats can be used for playlist sources, input.http streams and manually using request.create."
---
...
### Remote M3U playlist example {#remote-m3u-playlist-example}
...
## Special case: CUE format {#special-case-cue-format}
