...
description: "The %ffmpeg encoder should support all the options for ffmpeg's muxers and encoders, including private configuration options. Configuration value are…"
---
...
### Interleaved muxing {#interleaved-muxing}
