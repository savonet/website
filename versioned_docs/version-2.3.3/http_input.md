---
title: "HTTP input"
description: "Liquidsoap can create a source that pulls its data from an HTTP location. This location can be a distant file or playlist, or an icecast or shoutcast…"
---
...
```liquidsoap title="http-input.liq"
# url is a HTTP location, like http://radiopi.org:8080/reggae
