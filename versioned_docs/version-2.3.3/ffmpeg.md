...
description: "Since the 2.0.x release cycle, liquidsoap integrates a tight support of ffmpeg. This includes:"
sidebar_label: "FFmpeg support"
---
...
### fdk-aac support in ffmpeg {#fdk-aac-support-in-ffmpeg}
...
### Decoder arguments {#decoder-arguments}
...
our [extra API reference](./reference-extras/index.mdx). Here's one such filter:
...
### Relaxed copy content compatibility check {#relaxed-copy-content-compatibility-check}
