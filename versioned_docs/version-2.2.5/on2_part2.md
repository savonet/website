---
title: "Building an advanced stream: file-based sources"
description: "The purpose of this part is to document and illustrate the creation of an advanced stream using static files."
---
...
### Notify when a song is played {#notify-when-a-song-is-played}
...
### Infallible sources {#infallible-sources}
...
## More advanced functions! {#more-advanced-functions}
...
### Smart crossfade {#smart-crossfade}
...
### Enabling shoutcast clients {#enabling-shoutcast-clients}
...
### A nice transition! {#a-nice-transition}
