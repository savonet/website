...
description: "Encoders are used to define formats into which raw sources should be encoded by an output. Syntax for encoder is: %encoder(parameters...) or, if you…"
---
...
## Formats determine the stream content {#formats-determine-the-stream-content}
...
# List of formats and their syntax {#list-of-formats-and-their-syntax}
...
Please refer to the [Gstreamer encoder](./gstreamer_encoder.md) page for a detailed explanation
of this encoder.
