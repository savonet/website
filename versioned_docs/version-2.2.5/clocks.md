...
## Why multiple clocks {#why-multiple-clocks}
...
### Disjoint clocks {#disjoint-clocks}
...
## External clocks: decoupling latencies {#external-clocks-decoupling-latencies}
...
## Internal clocks: exploiting multiple cores {#internal-clocks-exploiting-multiple-cores}
