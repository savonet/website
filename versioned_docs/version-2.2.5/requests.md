---
title: "An abstract notion of files: requests"
description: "The request is an abstract notion of file which can be conveniently used for defining powerful sources. A request can denote a local file, a remote…"
