...
description: "Append an extra track to every track. Set the metadata 'liqappend' to 'false' to inhibit appending on one track."
---
### `append` {#append}
...
### `source.drop.audio` {#source.drop.audio}
...
### `source.drop.metadata` {#source.drop.metadata}
...
### `source.drop.midi` {#source.drop.midi}
...
### `source.drop.video` {#source.drop.video}
...
### `source.frame.duration` {#source.frame.duration}
...
### `source.frame.rms` {#source.frame.rms}
...
### `source.mux.audio` {#source.mux.audio}
...
### `source.mux.midi` {#source.mux.midi}
...
### `source.mux.track.audio` {#source.mux.track.audio}
...
### `source.mux.track.video` {#source.mux.track.video}
...
### `source.mux.video` {#source.mux.video}
...
### `source.on_metadata` {#source.on_metadata}
...
### `source.on_track` {#source.on_track}
