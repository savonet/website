...
description: "Liquidsoap might also reject a script with a series of errors of the form this value has type ... but it should be a subtype of ... . Usually the last…"
---
## What does this message means? {#what-does-this-message-means}
...
### We must catchup x.xx! {#we-must-catchup-x.xx}
