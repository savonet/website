...
### Handling of streaming errors {#handling-of-streaming-errors}
...
### How often (in seconds) we should indicate catchup errors. {#how-often-in-seconds-we-should-indicate-catchup-errors.}
...
### Tentative frame duration in seconds {#tentative-frame-duration-in-seconds}
...
### Display unix timestamps (subsecond accuracy, timezone independant) {#display-unix-timestamps-subsecond-accuracy-timezone-independant}
...
##### Priority for the taglib metadata decoder {#priority-for-the-taglib-metadata-decoder}
...
## Streaming clock settings {#streaming-clock-settings}
...
### How much data should be buffer from each track when computing crossfade transitions. This will be shorter if one of the track is shorter than that. {#how-much-data-should-be-buffer-from-each-track-when-computing-crossfade-transitions.-this-will-be-shorter-if-one-of-the-track-is-shorter-than-that.}
...
### How to proceed with amplify data when `"liq_amplify"` is set. One of: `"keep"` (prefer user-provided value), `"override"` (always override with computed value), `"ignore"` (ignore/suppress loudness adjustment). {#how-to-proceed-with-amplify-data-when-liq_amplify-is-set.-one-of-keep-prefer-user-provided-value-override-always-override-with-computed-value-ignore-ignoresuppress-loudness-adjustment.}
...
#### File extensions used for decoding metadata using TAGLIB {#file-extensions-used-for-decoding-metadata-using-taglib}
...
#### Mime-types used for decoding metadata using TAGLIB {#mime-types-used-for-decoding-metadata-using-taglib}
...
### Taglib settings {#taglib-settings}
