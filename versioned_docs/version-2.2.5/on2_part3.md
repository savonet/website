---
title: "Visualization"
description: "This part is pretty open. We describe below a few advanced features of liquidsoap, including video and midi. We provide some examples or simply propose…"
---
...
## Static image over audio track {#static-image-over-audio-track}
...
# Manipulating MIDI data {#manipulating-midi-data}
...
## Listener-sensitive radio {#listener-sensitive-radio}
...
## Liquidsoap script generator {#liquidsoap-script-generator}
...
## Re-usable tools for radios {#re-usable-tools-for-radios}
