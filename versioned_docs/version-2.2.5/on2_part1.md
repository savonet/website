---
title: "Run liquidsoap on one-liners"
description: "This part starts from scratch. All you need is a working install of liquidsoap. If you don't have one already, we can help you; but if you haven't,…"
---
...
## Play a synthesized sound {#play-a-synthesized-sound}
...
## Play a list of files {#play-a-list-of-files}
...
## An interactive example {#an-interactive-example}
...
# Using liquidsoap in production {#using-liquidsoap-in-production}
...
## Checking a media file {#checking-a-media-file}
...
# Get comfortable with the language {#get-comfortable-with-the-language}
...
## Sequencing, returning {#sequencing-returning}
...
## Labels and optional parameters {#labels-and-optional-parameters}
